...
export const en = {
	...
	'launcher.recentBooks': 'Recent books',
	'launcher.noRecentBooks': 'No book opened yet.',
	'launcher.openBook': 'Open a book…',
	'launcher.bookSubtitle': 'A book is any folder of markdown files — no setup required.',
	'launcher.removeRecent': 'Remove from recent',
	'launcher.removeConfirm': 'Remove "{name}" from the recent list?',
	...
	'book.ltDisconnected': 'Disconnected',
	'book.ltDrawerTitle': 'Grammar & Spelling',
	'book.ltCheckDocument': 'Check',
	'book.ltChecking': 'Checking…',
	'book.ltNoIssues': 'No issues found!',
	'book.ltIssueCount': '{count} issue(s) found',
	'book.ltSuggestions': 'Suggestions:',
	'book.ltRemove': '(remove)',
